...
case class ClinicalTrialAgreement(id: ClinicalTrialAgreementId, version: EntityVersion) extends VersionedEntity[ClinicalTrialAgreement, ClinicalTrialAgreementId] {
