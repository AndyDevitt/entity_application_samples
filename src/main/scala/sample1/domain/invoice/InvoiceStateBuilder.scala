...
import cats.Id
import sample1.domain.command.{Command, CreateRfiInvoiceCmdG, CreateSiteInvoiceCmdG}
...
object InvoiceStateBuilderTest {
  ...
  val sponsorInv: SponsorInvoice = Invoice.createRfiInvoiceG(CreateRfiInvoiceCmdG(UserId()))
